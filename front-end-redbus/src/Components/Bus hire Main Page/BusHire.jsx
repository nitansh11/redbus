            ...
            <div className = {Styles.baneer}>
                <div>
                    ...
                    <div className = {Styles.bannerElementDiv}>
                        ...
                        <div><img src = "https://www.redbus.in/bushire/static/webv2/home/3%20(1).svg" alt = "" /></div>
                    </div>
                </div>
               ...
               <div className = {Styles.whyBookWithBushire}>
                ...
                <BusHirePricing/>
                 ...
                 <div className = {Styles.VehicleYouCanGet}>
                    ...
                    The buses can be hired not only for tourism, but also for leisure activities like picnics, field trips, excursions, and formal requirements like corporate events, meetings, weddings, and more.
                    </div>
                    <div className = {Styles.hireuswhenever_paraSection}>No matter whether you want to hire/rent a vehicle for a whole day or just a few hours, we will meet your needs. Bus for hire is now one click away. We also ensure extra comfort, luxurious and hassle-free experience, and of course, a punctual and expert service</div>
                </div>
                ...
                <div className = {Styles.VehicleYouCanGet}>
                    ...
                    <div className = {Styles.hireuswhenever_paraSection}>
                    redBus has identified the public’s love of travel and has made the renting/hiring of buses and tempo travellers easy. We hold almost 10,000 buses, covering almost 60,000 routes throughout India equipped with a 24 hour tracking device, all available for booking online.
                    </div>
                    <div className = {Styles.hireuswhenever_paraSection}>You can rent, hire, or book buses online though our official website or by downloading our app on your mobile phones.</div>
                    <div className = {Styles.hireuswhenever_paraSection}>All you have to do is enter your reason for hiring, your starting point, and your place of destination. Following this, you are required to enter the type of vehicle you prefer with the number of travellers. No booking cost is levied at the time of payment.</div>
                ...
                <div className = {Styles.VehicleYouCanGet}>
                    ...
                    <div className = {Styles.hireuswhenever_paraSection}>
                    redBus is amongst the list of renowned online bus booking websites. It has earned its place among the best due to its ability to cater to every customer’s specific travel needs while also providing them with nothing but the best travel experience. In doing so, they provide their customers with a plethora of bus booking options. It works with only the best operators and ensures that only the most experienced drivers drive buses. redBus makes booking an ordinary vehicle, such as a tempo traveller or minibus, for a group vacation much more comfortable and more accessible. redBus offers customers with air-conditioned as well as non-air-conditioned buses to choose from and book. It also provides sleeper buses that operate at night. redBus bus hire and redBus bus rental can be done either through the use of the official website or the easy to download redBus application.

                    </div>
                    <div className = {Styles.hireuswhenever_paraSection}>redBus has been making sure to take care of all its customer’s health and also play a role in curbing the further spread of COVID-19. In a bid to do just this, redBus has come out with an initiative called Safety+ under which there are specific preventive guidelines all buses must adhere to. Some of these are as follows:</div>
                    <ul className = {Styles.list}>
                        <li><BsCircleFill style = {{marginRight : "10px" , fontSize : "7px"}}/>Passengers, as well as staff and employees, are strictly required to wear masks at all times</li>
                        <li><BsCircleFill style = {{marginRight : "10px" , fontSize : "7px"}}/>Suspension of the complimentary provision of cover-ups temporarily to prevent contact spread</li>
                        <li><BsCircleFill style = {{marginRight : "10px" , fontSize : "7px"}}/>Mandatory requirement of sanitisers and disinfectants</li>
                        <li><BsCircleFill style = {{marginRight : "10px" , fontSize : "7px"}}/>Deep and thorough sanitation of all vehicles</li>
                    </ul>

                </div>
                {/* must keep in mind specific tips.  */}
                <div className = {Styles.VehicleYouCanGet}>
                    <div className = {Styles.bookInEasySteps_heading} style = {{width : "40%"}}>
                    While booking a bus online, one must keep in mind specific tips. These are listed as follows:
                    </div>
                    
                    <ul className = {Styles.list}>
                        <li><BsCircleFill style = {{marginRight : "10px" , fontSize : "7px"}}/>It is essential to make sure that the online bus booking service that you choose is reliable and trustworthy like redBus.</li>
                        <li><BsCircleFill style = {{marginRight : "10px" , fontSize : "7px"}}/>Look to see if the online bus booking service of your choice meets all your expectations and services all your specific travel needs. redBus, through the provision of the filters option, allows its passengers to curate a trip by following their travel needs.</li>
                        <li><BsCircleFill style = {{marginRight : "10px" , fontSize : "7px"}}/>Make sure to carry a sanitiser and mask to all the locations you are visiting.</li>
