            ...
            <div className={Styles.tripTypecontainer}>
                ...
                <div style={{ display: "flex", flexDirection: "column", backgroundColor: " #e6f2ff", padding: "20px" }}>
                    ...
                    <div className={Styles.journeyTypeDiv} onClick={handleClick}>
                        ...
                        <div><img src="https://www.redbus.in/bushire/static/images/asset_outstation.png" alt="" height="90px" /></div>
                    </div>
                    <div className={Styles.journeyTypeDiv}>
                        ...
                        <div><img src="https://www.redbus.in/bushire/static/images/asset_local.png" alt="" height="90px" /></div>
                    </div>
                    <div className={Styles.journeyTypeDiv}>
                        <div style={{ display: "flex", flexDirection: "column" }}>
                        ...
                        <div><img src="https://www.redbus.in/bushire/static/images/asset_airport.png" alt="" height="90px" /></div>
                    </div>
                </div>
