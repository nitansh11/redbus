...
const FAQ = () => {
    ...
    const [arrow13 , setArrow13] = React.useState("downArrow")
    const [arrow14 , setArrow14] = React.useState("downArrow")
    const handleArrow1 = () =>{
        if(arrow1 === "downArrow"){
            setArrow1("upArrow")
        }
    ...
    const handleArrow13 = () =>{
        if(arrow13 === "downArrow"){
            setArrow13("upArrow")
        }
        else{
            setArrow13("downArrow")
        }
        if(arrow13 === "upArrow"){
            setArrow13("downArrow")
        }
    ...
    const handleArrow14 = () =>{
        if(arrow14 === "downArrow"){
            setArrow14("upArrow")
        }
        else{
            setArrow14("downArrow")
        }
        if(arrow14 === "upArrow"){
            setArrow14("downArrow")
        }
